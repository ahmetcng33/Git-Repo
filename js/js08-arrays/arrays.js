...
// console.log(colors.splice(2,1)); //2. indexe git sonra 1 eleman sil.

// console.log(colors.splice(2)); //2. indexe git sonraki bütün elemanları sil

//!Eleman ekleme

// console.log(colors.splice(2,0,'White')); //2. indexe git 0. eleman sil ve whiteyi ekle. Silmediği için boş array döner.

// console.log(colors.splice(0,1,"Pink")); //0. indexe git 1 eleman sil sonra pink ekle .

// console.log(colors.splice(3,1,"Pink", "Black")); //3. indexe git sonra 1 eleman sil 2 eleman ekle .
...
//Üsttekiyle anyı işi yapar.
// const destr = color1.push(...color1,...color2)
// console.log(color1);

//concat değer döndürür değeri değiştirmez tekrar bi değere atmamız gerekir ya da clg içinde yazmamız lazım
// console.log(color1.concat(color2,"Black", 2));
...
//! reverse  
/* const colors = ["Red", "Green", "Blue", "Yellow", "Brown"];
colors.reverse() //orjinal arrayi değiştirir
console.log(colors); */
...
console.log(arr)
 */
//örjinal array bozulmaz. Array i stringe çevirir.

//! sort
//bir arrayi numbe olarak sıralamakta kullanır 
/* 
const arr = [ 55, 5, 22, 2, 11, 1, 111 ]
arr.sort()
console.log(arr);
 */
// ascending sorting - küçükten büyüğe
/* arr.sort((a,b) => a-b)
console.log(arr) // [ 1, 2, 5, 11, 22, 55, 111 ]
 */
// descending sorting - büyükten küçüğe 
/* arr.sort((a,b) => b-a)
...
console.log(arr[2][1][1]) //e */

const arr = ["Red", "Green",,"Blue"]
console.log(arr.splice(2,1,"black"));
console.log(arr);